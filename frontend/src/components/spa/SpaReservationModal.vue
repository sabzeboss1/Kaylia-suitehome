...
const handleSubmit = async () => {
  ...
  try {
    ...
    // Mettre à jour le store pour passer le guard de navigation (pour SPA, on utilise un ID fictif)
    bookingStore.apartment = {
      id: 9999, // ID fictif pour SPA
      name: props.serviceName || 'Service SPA'
    }
