<template>
  <div class="apartment-card bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-in-up" :class="staggerClass">
      ...
      <div class="md:col-span-3 p-8 md:p-10">
        ...
        <div class="mt-auto">
          <div class="mb-6">
            ...
            <div class="text-sm text-gray-500 mt-1">+ {{ taxAmount }}€ de taxe de séjour ({{ nightCount }} nuits)</div>
          </div>
          <button 
            @click="handleReserve"
...
const taxAmount = computed(() => {
  // Simple calculation: 11€ per night
  return nightCount.value * 11
})
