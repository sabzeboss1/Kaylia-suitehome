        ...
        <div class="container mx-auto px-6 py-12">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        ...
                        <li>
                            <a href="mailto:<?php echo CONTACT_EMAIL; ?>" class="hover:text-white transition">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <?php foreach ($footerLinks as $link): ?>
                            <li>
                                <a href="<?php echo $link['url']; ?>" class="hover:text-white transition">
                                    <?php echo $link['title']; ?>
                                </a>
                            </li>
                        <?php endforeach; ?>
            ...
            <div class="border-t border-gray-800 pt-6">
                <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 gap-4">
                    <p>Copyright <?php echo SITE_NAME; ?>, tous droits réservés</p>
