...
import InstagramWidgetConfig from '../components/InstagramWidgetConfig.vue';
import ReviewsWidgetConfig from '../components/ReviewsWidgetConfig.vue';
import DepositConfigForm from '../components/DepositConfigForm.vue';
...
const DepositIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
...
const tabs = [
  ...
  { id: 'instagram', label: 'Instagram', icon: SocialIcon },
  { id: 'reviews', label: 'Avis', icon: SocialIcon },
  { id: 'email', label: 'Email', icon: EmailIcon },
  { id: 'payment', label: 'Paiement', icon: PaymentIcon },
  { id: 'deposit', label: 'Dépôt', icon: DepositIcon },
